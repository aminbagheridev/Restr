...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Color(#colorLiteral(red: 0.05882352941, green: 0.003921568627, blue: 0.1137254902, alpha: 1))
                .ignoresSafeArea()
            content
        }
    }
    ...
    var content: some View {
        ZStack {
            VStack(spacing: 40) {
                ...
                Text(title)
                    .font(.headline)
                    .foregroundColor(Color(#colorLiteral(red: 0.3842352941, green: 0.5176470588, blue: 1, alpha: 1)))
